...
export default function AboutSection() {
  ...
  return (
    <section id='about' className=' w-full py-32 flex flex-col items-center bg-brancoFosco-100 text-black'>
      <div className='flex flex-col gap-8 w-11/12 max-w-[1200px] '>
        ...
        <div className="flex gap-24 max-[900px]:flex-col max-[900px]:gap-20">
